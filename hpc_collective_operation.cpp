...
int main ( int argc , char *argv[ ] ){
	...
	int divisibile = vett % numproc; //take the rest 
	...
	if (myid ==0) { //if I am the master process gather results from others
		...
		MPI_Gather(somma_parziale, 1, MPI_UNSIGNED, somma, 0, MPI_UNSIGNED, 0, MPI_COMM_WORLD)
